---
title: "【SLA×データ分析】スピーキングの語彙定着度を「上位・中位・下位」で可視化するツール"
emoji: "📊"
type: "tech"
...
# 【SLA×データ分析】英語教員向け：生徒のスピーキングテストの発話を通して、単語の定着度を「上位・中位・下位」で可視化するブラウザツール
...
指導への活かし方:
先生が「言えなきゃダメだ」と思っていたにも関わらず、全体が使えていない状態です。これは生徒の責任というより、**「インプット時の印象付けが弱かった」か、「生徒の現在のレベルに対して単語の難易度が高すぎた」**という教材・指導側の課題として受け止めることができます。次回の帯活動などで先生が積極的にその単語を使ったり、クラス全体への再指導（フラッシュカードでの反復など）が必要です。
